...
\item \textit{Multi-Agent Coordination Security}.  Cascading failures, rogue agent infiltration, and covert inter-agent collusion in multi-agent systems, and defenses against them [\eg \cite{gu2024agentsmith}].

\item \textit{Agent-Tool Integration}. Trust boundary violations  or privilege escalation when agents interact with external tools or protocols such as MCP, and defenses against them [\eg \cite{wu2025isolategpt}].

\item \textit{Agent-Memory Attack}. Attacks that compromise the long-term memory or knowledge bases of LLM agents, and defenses against them  [\eg \cite{chen2024agentpoison}].

\item \textit{Agentic Knowledge Attacks}. Knowledge base poisoning, backdoored retrievers, and corrupted upstream components that persistently manipulate agents, and defenses against them [\eg \cite{zou2025poisonedrag}].


\item \textit{Agentic Control Flow Attacks}. Attacks that hijack agent decision-making at runtime by manipulating planning, and defenses against them[\eg \cite{zhang2025asb, xu2026storage}].

\item \textit{Privacy and Data Leakage}. Training data extraction, membership inference, and sensitive data leakage, and mitigation against them [\eg \cite{lukas2023analyzing, carlini2023memorization}].
\end{itemize}

\item \textbf{Agentic AI Reliability} including but not limited to:
\begin{itemize}[itemsep=1pt,topsep=0pt]

\item \textit{Hallucination and Factuality}. Factual errors compounding across multi-step agent reasoning chains, and evaluation and mitigation strategies for ensuring factual reliability [\eg \cite{lin2022truthfulqa, tian2023finetuning}].

\item \textit{Human Oversight}. Mechanisms for meaningful human intervention in autonomous agent systems, addressing the scalability of oversight and risks of automation bias [\eg \cite{burns2024weak, kenton2024scalable}].

\item \textit{Interpretability and Explainability}. Understanding LLM internals, enabling auditing, debugging, and behavioral intervention in deployed agent systems [\eg \cite{conmy2023automated, tigges2024llm}].

\item \textit{Testing, Debugging, and Evaluation}. Dynamic testing, fault localization, and systematic evaluation of agentic AI systems under real-world deployment conditions [\eg \cite{jimenez2024swebench, xia2025agentless, xia2023automated}].
\end{itemize}
\item \textbf{Governance}. Regulatory frameworks and institutional practices for establishing responsibility, auditability, and compliance for agentic AI systems in high-stakes domains [\eg \cite{mitchell2019model, bender2021stochastic}].
\item \textbf{Broader Path to Reliable AI}. Architectural and training paradigm advances that move beyond next-token prediction toward richer world models and more reliable internal representations, enabling more robust and trustworthy agentic behavior [\eg \cite{huang2026llmjepa}].
\end{itemize}
...
\textbf{Bang Liu} (he/him) 
%is a Canada CIFAR AI Chair at Mila and Associate Professor at Université de Montréal. He received his PhD from the University of Alberta in 2020. His research spans NLP, multimodal and embodied learning, agentic AI, and AI for science. He has served as Area Chair for NeurIPS, ICLR, ICML, and ACL, and as Action Editor for Neural Networks. His honors include the Amazon Research Award, WAIC Yunfan Awards, and the University of Montreal Research Excellence Award. He has co-organized five international workshops.
is a Canada CIFAR AI Chair at Mila and an Associate Professor in the Department of Computer Science and Operations Research (DIRO) at the Université de Montréal. He received his PhD from the University of Alberta in 2020. His research focuses on natural language processing, multimodal and embodied learning, agentic intelligence, and AI for science. He has served as the area chair of conferences such as NeurIPS, ICLR, ICML, ACL and so on, as well as the action editor of the Neural Networks journal. He has won the Amazon Research Award (2025 Spring), 2025 WAIC Yunfan Award (Bright Star), the 2024 WAIC Yunfan Award (Rising Star), the University of Montreal Research Excellence Award, the WWW 2023 Best Paper Nomination, the George Walker PhD Thesis Award, etc. He has co-organized five international workshops. 
He has another concurrent NeurIPS 2026 Workshop submission named Trustworthy Evolution of AI Agents.
\orginfo{bang.liu@umontreal.ca}{https://www-labs.iro.umontreal.ca/~liubang/}{lmfAnP4AAAAJ}

\textbf{Feng Liu} (he/him) is a senior lecturer (US associate professor) at the University of Melbourne, Australia. His research focuses on statistical hypothesis testing and trustworthy machine learning. He received an outstanding paper award from NeurIPS ‘22, the Australasian AI Emerging Research Award from the Australian Computer Science Society in 2024, and the Discovery Early Career Researcher Award from the Australian Research Council in 2023. He presented tutorials at ECML ‘24, IJCAI ‘24, AAAI ‘24, ACML ‘23, ACML ‘24, and AAAI ‘26 on trustworthy machine learning. He also organized five international workshops as program chairs, one national Australian AI conference as a local arrangement chair, and NeurIPS ‘26 as a communication chair.
...
\textbf{Javen Qinfeng Shi} (he/him) is a Professor and Founding Director of the Causal AI Group at Adelaide University, Australia. His research focuses on causation, AI, and probabilistic graphical models. He is internationally recognised for highly ranked contributions in causation and graphical models, with impactful applications across materials discovery, agriculture, mining, manufacturing, and bushfire management. His work has received the ACM SIGIR 2025 Test of Time Award, top placement in the Open Catalyst Challenge (NeurIPS AI for Science 2023), and multiple global competition wins and finalist recognitions in areas ranging from bushfire prediction to industrial AI and digital manufacturing innovation. 
\orginfo{javen.shi@adelaide.edu.au}{https://javenshi.org/}{h6O9vYkAAAAJ}

\textbf{Yiliao (Lia) Song} (she/her) is a lecturer in Machine Learning at Adelaide University. Her research focuses on trustworthy machine learning in non-i.i.d. settings. She has been recognised through the Emerging Research Contribution Award from the Australian Computer Society and the DAAD–AINeT Fellowship. She has served leadership roles within the AI research community, including Program Chair (2024), Sponsorship Chair (2023) and Publication Chair (2026) for the Australasian Joint Conference on Artificial Intelligence, and Workshop and Tutorial Chair for the 26th International Conference on Digital Image Computing: Techniques and Applications.
...
\textbf{Yu Yao} (he/him) is a Lecturer in Machine Learning at University of Sydney. He completed his PhD at the University of Sydney, and held a postdoctoral fellowship at Mohamed bin Zayed University of Artificial Intelligence. He received the Discovery Early Career Researcher Award from the Australian Research Council in 2026, received an Outstanding Area Chair Award at ICML 2025, served as an oral session chair at ICLR 2025, and organized multiple workshops. His research focuses on agentic AI and weakly supervised learning.
\orginfo{yu.yao@sydney.edu.au}{a5507203.github.io}{OkcaMKAAAAAJ}


    % \item Guohao Li (\textcolor{orange}{Tentative}, UK- CAMEL-AI.org): Guohao Li is an artificial intelligence researcher and an open-source contributor working on building intelligent agents that can perceive, learn, communicate, reason, and act. He is the core lead of the open source projects CAMEL-AI.org and DeepGCNs.org.
% \end{itemize} 
\hl{Organizers' Profiles for Workshop's Success}. This workshop brings together multiple research communities and technical domains, requiring substantial coordination and discussion across a wide range of decisions. Accordingly, a team of eight organizers is needed to provide the breadth of expertise, community representation, and organizational capacity required to deliver a high-quality and inclusive workshop. The organizing committee combines expertise in trustworthy machine learning, AI safety, security, and governance, providing the breadth needed to curate a high-quality program. Several organizers have extensive experience leading workshops at premier AI venues such as NeurIPS, ICML, and ICLR. The team also includes Australia-based researchers who can support local coordination for NeurIPS 2026 in Sydney, alongside junior researchers whose involvement helps foster the next generation of leaders in the agentic AI trustworthiness community.

\sectiontitle{Program Committee (PC) Members (alphabetical order)}
\vspace{-2pt}
The PC members of this workshop include senior PhD candidates, early-career faculty members, and mid-career faculty members.
% PC members need to provide high-quality reviews for all submissions, for which we require three reviews per submission. The current list is shown below. 
Additional PC members will be recruited after acceptance, expanding the committee to at least 60 members to support an estimated 60 submissions.
\begin{itemize}[leftmargin=10pt,nosep]
% \item Maksym Andriushchenko, Postdoctoral Researcher, EPFL, Switzerland
...
% \item Francesco Croce, Postdoctoral Researcher, University of Tübingen, Germany
...
\item Sarah Erfani, Professor, University of Melbourne, Australia
\item Mingming Gong (\confirmed), Associate Professor, University of Melbourne, Australia
\item Bo Han (\confirmed), Associate Professor, Hong Kong Baptist University Faculty of Science
% \item Moritz Hardt, Professor, Max Planck Institute for Intelligent Systems, Germany
\item Zhuo Huang (\confirmed), PhD Candidate, University of Sydney, Australia
% \item Hima Lakkaraju, Associate Professor, Harvard University, United States
...
% \item Aditi Raghunathan, Assistant Professor, Carnegie Mellon University, United States
% \item Reza Shokri, Associate Professor, National University of Singapore, Singapore
\item Danica J Sutherland, Assistant Professor, University of British Columbia, Canada
\item Xunye Tian (\confirmed), PhD Candidate, University of Melbourne, Australia
\item Florian Tramèr, Associate Professor, ETH Zurich, Switzerland
\item Qizhou Wang (\confirmed), Postdoctoral Researcher, RIKEN-AIP, Japan
% \item Eric Wong, Assistant Professor, University of Pennsylvania, United States
\item Di Wu (\confirmed), Senior Lecturer, La Trobe University, Australia
\item Zesheng Ye (\confirmed), Postdoctoral Researcher, University of Melbourne, Australia
\item Yujia Zheng (\confirmed), Assistant Professor, UIUC, United States
\item Jiacheng Zhang (\confirmed), PhD Candidate, University of Melbourne, Australia
\item Zhanke Zhou (\confirmed), PhD Candidate, Hong Kong Baptist University, Hong Kong
...
\item Jianing Zhu (\confirmed), Postdoctoral Researcher, University of Texas at Austin, United States
